...
save_figure("s2_timecourse_example_trials", dpi = 300, height = 1.5, width = 3)
```
...
save_figure("s2_timecourse_example_session", dpi = 300, height = 2, width = 8)
```
...
pant/pout
save_figure("s2_timecourse_pooled", dpi = 300, height = 5, width = 6)
```
...
save_figure("s2_timecourse_method", dpi = 300, height = 3, width = 12)
```
...
p1a+p3a
save_figure("s2_timecourse_iti", dpi = 300, height = 3, width = 8)
```
...
pant/pout
save_figure("s2_timecourse_by_cue", dpi = 300, height = 7, width = 6)
```
...
pant/pout
save_figure("s2_timecourse_by_hit", dpi = 300, height = 5, width = 6)
```
...
pant/pout
save_figure("s2_timecourse_by_size", dpi = 300, height = 5, width = 6)
```
...
save_figure("s2_timecourse_by_emotion", dpi = 300, height = 6, width = 11)
```

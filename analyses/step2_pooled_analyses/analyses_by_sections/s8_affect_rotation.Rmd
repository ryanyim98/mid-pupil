...
save_figure("s8_affect_axes_by_study", dpi = 300, height = 4, width = 7)
...
save_figure("s8_affect_axes_pooled", dpi = 300, height = 4, width = 7)

fig2a <- image_read(mid_pupil_figure_path("s8_affect_axes_by_study", "png"))
fig2b <- image_read(mid_pupil_figure_path("s8_affect_axes_pooled", "png"))
...
save_figure_image("s8_affect_axes_combined", combined)
```

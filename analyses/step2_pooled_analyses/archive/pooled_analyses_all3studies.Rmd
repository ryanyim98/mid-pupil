...
t.test(acf_results_vrmid2$AR[acf_results_vrmid2$variable == "corrected phasic"])
t.test(acf_results_vrmid2$AR[acf_results_vrmid2$variable == "tonic"],
       acf_results_vrmid2$AR[acf_results_vrmid2$variable == "corrected phasic"],paired = T)
...
par1+par2+par3
ggsave(paste0("~/Desktop/VRMID-analysis/mid-pupil/figures/ar.png"),dpi = 300, height = 3, width = 12)
```
...
ggsave(paste0("~/Desktop/VRMID-analysis/mid-pupil/figures/fig5_beh.png"),dpi = 300, height = 8, width = 8)
...
p2b<-ggplot(vrmid2_regression_coefs_out_nobc, aes(x = sample_point,y = Estimate))+
  ...
  annotation_custom(
    grob = grid::rectGrob(gp = grid::gpar(fill = "white", alpha = 1, col = NA)),
    xmin = 18.1*120, xmax = 21*120, ymin = -Inf, ymax = Inf
  )

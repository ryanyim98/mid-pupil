...
data_pupil <- read_csv(paste0(getwd(),"/../../data/study1/pupillometry.csv"))%>%
...
write_csv(data_pupil_out, "~/Desktop/VRMID-analysis/vrmid-pupillometry/data/study1/pupillometry_lowpass_baselineCorrected.csv")

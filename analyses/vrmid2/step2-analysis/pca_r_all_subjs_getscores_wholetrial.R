...
my.data <- read_csv("~/Desktop/VRMID-analysis/vrmid-pupillometry/data/study2/pupil_for_pca.csv")
...
candidate_luminance_pc_ant <- c("PC1","PC4","PC8","PC9","PC12")
...
protout
###### get 'cleaned' data
candidate_luminance_pc_out<-c("PC2","PC4","PC8","PC9","PC11")
...
pcleanant/pcleanout
ggsave("~/Desktop/VRMID-analysis/vrmid-pupillometry/figures/pca/study2_all_pupil_pca_cleaned.png",dpi = 300, height = 7, width = 14)

pant/pout
ggsave("~/Desktop/VRMID-analysis/vrmid-pupillometry/figures/pca/study2_all_pupil_pca.png",dpi = 300, height = 7, width = 14)


protant/protout
ggsave("~/Desktop/VRMID-analysis/vrmid-pupillometry/figures/pca/study2_all_pupil_pca_rot.png",dpi = 300, height = 10, width = 6)


all_clean_data <- rbind(cleaned_data_long_ant,cleaned_data_long_out)
write_csv(all_clean_data,"~/Desktop/VRMID-analysis/vrmid-pupillometry/data/study2/pupil_cleaned.csv")
